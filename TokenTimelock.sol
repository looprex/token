...
contract TokenTimelock {
    ...
    ITRC20 private _token; // = ITRC20(address(TVN3EsVE2TZ22K3uuKc7qPwHoF98izYzTX));

    IJustswapExchange public swap; // = IJustswapExchange(address(TSvhxeT3FD4WfcaKXDn75RJ6q5gL3yesAS));
    ...
    function getTokenPrice(uint256 tokens_sold) public view returns (uint256) {
